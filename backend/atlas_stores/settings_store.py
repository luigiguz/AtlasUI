...
def _from_env_and_file(file_cfg: dict[str, str | bool]) -> dict[str, str | bool]:
    ...
    git_username = atlas_env("ATLAS_STORES_GIT_USERNAME") or str(file_cfg.get("git_username", ""))
...
def load_stores_settings() -> dict[str, str | bool]:
    ...
    file_cfg: dict[str, str | bool] = {
        ...
        "git_username": str(raw.get("git_username", "")).strip(),
...
def save_stores_settings(
    *,
    ...
    username = git_username.strip() or str(prev.get("git_username") or "")
